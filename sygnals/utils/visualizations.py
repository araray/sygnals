...
def plot_spectrogram(data, sr, output_file, f_min=None, f_max=None, window='hann', nperseg=1024):
    """
    ...
    plt.pcolormesh(t, f, 10 * np.log10(Sxx + 1e-10), # Add small constant to prevent log(0)
                  shading='gouraud')
